...
%prep
%setup -q -n WebTest-2.0.34
cd %{_builddir}/WebTest-2.0.34
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580321532
...
cp %{_builddir}/WebTest-2.0.34/license.rst %{buildroot}/usr/share/package-licenses/WebTest/93f88a0f4df0e1130383927f839a05c85d2f675f
